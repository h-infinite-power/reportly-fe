  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white/6 border border-white/10 backdrop-blur-[4px] rounded-xl overflow-hidden">
        {/* Question Header */}
        <div
          className="flex items-center justify-between p-6 gap-10 w-full cursor-pointer"
          onClick={onToggle}
        >
        ...
        {/* Answer Content */}
        {isExpanded && (
          <div className="flex flex-col justify-center items-start p-8 gap-4 w-full bg-black/20 border-white/10">
